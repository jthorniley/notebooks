...
#  type.
#c.Exporter.default_preprocessors = ['nbconvert.preprocessors.TagRemovePreprocessor', 'nbconvert.preprocessors.ConvertFiguresPreprocessor']
...
#  `cell.metadata.tags`.
c.TagRemovePreprocessor.remove_input_tags = set(['remove_input'])
